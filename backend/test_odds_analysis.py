from src.scrape.odds_analysis import analyse_historical_odds, analyze_scrape_odds
...
# Bookmakers means that only when one of my bookmakers has the best bet I will bet?
# bookmakers = ["bet365", "Pinnacle", "William Hill", "Unibet"]
bookmakers = None
nof_odds_cutoff = 8
perc_over_mean_cutoff = 3
stds_over_mean_cutoff = 1.7
