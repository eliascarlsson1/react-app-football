...
def update_leagues() -> str:
    ...
    if "PL" in leagues:
        ...
        with open(relevant_abs_path + "/PL" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/PL" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "L1" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/L1" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/L1" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "BL" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/BL" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/BL" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "SA" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/SA" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/SA" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "LL" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/LL" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/LL" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "CS" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/CS" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/CS" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "E2" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/E2" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/E2" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "S2" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/S2" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/S2" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "SB" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/SB" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/SB" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "D2" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/D2" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/D2" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "NE" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/NE" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/NE" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "BE" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/BE" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/BE" + year + ".csv", "wb") as f:
            f.write(response.content)
    ...
    if "PO" in leagues:
        ...
        response = requests.get(url)
        with open(relevant_abs_path + "/PO" + year + ".csv", "wb") as f:
            f.write(response.content)
        with open(all_abs_path + "/PO" + year + ".csv", "wb") as f:
            f.write(response.content)
